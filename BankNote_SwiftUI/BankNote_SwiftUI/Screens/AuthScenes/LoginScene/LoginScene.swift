    ...
    var body: some View {
        BaseScene(contentView: {
            BaseContentView(withScroll:false, content: {
                LoginContentView(username: "", password: "", onSignInTap: { username, password, isRememberMe in
                    viewModel.callUsrAuthinticationByEmailAndMobileAPI(username: username, password: password, isRememberMe: isRememberMe)
                }, onForgotNameTap: {
