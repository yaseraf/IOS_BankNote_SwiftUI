...
extension GetExchangeSummaryUIModel {
    ...
    static func testUIModel()->Self {
        return GetExchangeSummaryUIModel(aboutDescA: "", aboutDescE: "", avg5Days: [], buyCashFlowPerc: "", companyDIVIDENDYIELDPERC: "", companyFACEVALUE: "", companyMARKETCAP: "", companyPERATIO: "", confirmMessage: "", confirmMessageAR: "", currentValue: "", dayRange: "", depthAvailable: "", eMName: "", equityTransferComm: "", exchangeID: "", exchangeNameA: "", exchangeNameE: "", exchangeType: "", high: "", indexCode: "", indexAvailable: "", k: "", lastUpdateTime: "", low: "", mName: "", netChange: "", netChangePerc: "", orderIndex: "", r1: "", r2: "", s1: "", s2: "", statusCode: "", symbolsDown: "", symbolsTraded: "", symbolsUP: "", symbolsUnChange: "", totalExecuted: "", turnOver: "", volume: "", isDefault: "", orderBy: 0, wk52High: 0, wk52Low: 0, wk52Range: "", isinCode: "")
    }
}
